...
void calc_colors(RGB_Pixel *colors) {
    //Parallelizing the for loop for iterations of the colors
...
//the runtime schedule allows the system to determine how to schedule the loop
//thus taking advantage of the system determining the best use of your system's resources
